...
<table WIDTH="100%">
		<tr>	
			<td>
				<img title="DOOSAN"  title="DOOSAN" src="img/doosan.jpg" style="width: 200px; border: 3px solid white;"  >		
			</td>
			<td>
				<center>
					...
					<BR>
						...
						<a href="#" onclick="display_('upload');">
						<button class="Envoi">
						Envoi de fichier
						</button>
						</a>
						
						<a href="#" onclick="display_('mkdir');">
						<button class="org">
						Nouveau dossier
						</button>
						</a>
...
echo "<INPUT class=\"Suppr\" TYPE=SUBMIT VALUE='Activer la suppression'>";
echo "</FORM>";
}else{
	echo '<FORM ACTION="#" METHOD=POST>';
echo "<INPUT TYPE=HIDDEN SIZE=1 NAME='delete' VALUE='No'>";
echo "<INPUT class=\"Suppr\" TYPE=SUBMIT VALUE='Desactiver la suppression'>";
echo "</FORM>";
}
?>
</div>
